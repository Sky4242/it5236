...
class Application {
    ...
    public function auditlog($context, $message, $priority = 0, $userid = NULL){
        ...
        /* 
		$url = "https://nrure58hjl.execute-api.us-east-1.amazonaws.com/default/auditLog";
      $data = array(
        'context' => $context,
        'message'=>$message,
        'ipaddress'=>$ipaddress,
...
*/
    ...
    public function register($username, $password, $email, $registrationcode, &$errors) {
        ...
        if (sizeof($errors) == 0) {
			...
			$url = "https://nrure58hjl.execute-api.us-east-1.amazonaws.com/default/registeruser";
			$data = array(
				'userid'=>$userid,
				'username'=>$username,
    ...
    protected function sendValidationEmail($userid, $email, &$errors) {
      ...
      /*  $sql = "INSERT INTO emailvalidation (emailvalidationid, userid, email, emailsent) " .
        ...
        if ($result === FALSE) {
            ...
            $url = "https://nrure58hjl.execute-api.us-east-1.amazonaws.com/default/SendEmail";
			$data = array(
...
*/
    ...
    public function getUserRegistrations($userid, &$errors) {
        ...
        /* 
		$url = "https://nrure58hjl.execute-api.us-east-1.amazonaws.com/default/getuserrefistrations";
      $data = array(
        'context' => $context,
        'message'=>$message,
        'ipaddress'=>$ipaddress,
...
*/
	...
	$otp= bin2hex(random_bytes(3));
		...
		$message = "A request has been made to login into Chief! ".
		"Your one time password is: " . $otp;
		$headers ='From: webmaster@chief.it' . "\r\n" .
		'Reply-To: webmaster@chief.it' . "\r\n";
